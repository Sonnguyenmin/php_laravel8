                    ...
                    <div class="header-bottom">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href=""><img src="{{('Frontend/assets/images/logo/logo.png')}}" alt="logo"></a>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-7">
                                    ...
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="shop.html">SHOP </a>
                                                <ul class="mega-menu-style mega-menu-mrg-1" style="border-radius: 6px">
                                                    <li>
                                                        <ul>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a href="shop.html"><img src="{{('Frontend/assets/images/banner/banner-12.png')}}" alt=""></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li><a href="#">PAGES </a>
                                                <ul class="sub-menu-style" style="border-radius: 6px">
                    ...
                    <div class="row align-items-center">
                        <div class="col-5">
                            <div class="mobile-logo">
                                <a href="index-2.html">
                                    <img alt="" src="{{('Frontend/assets/images/logo/logo.png')}}">
                                </a>
                            </div>
                        </div>
                        <div class="col-7">
                            ...
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children"><a href="index-2.html">Home</a>
                                    <ul class="dropdown">
                                        ...
                                        <li><a href="index-10.html">Home version 9</a></li>
                                        <li><a href="index-11.html">Home version 10</a></li>
                                    </ul>
                                </li>
                ...
                <div class="cart-content">
                    ...
                    <ul>
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="{{('Frontend/assets/images/cart/cart-1.jpg')}}" alt=""></a>
                            </div>
                        ...
                        <li class="single-product-cart">
                            <div class="cart-img">
                                <a href="#"><img src="{{('Frontend/assets/images/cart/cart-2.jpg')}}" alt=""></a>
                            </div>
                            <div class="cart-title">
                                ...
                                <div class="quickview-wrap mt-15">
                                    <div class="nav nav-style-6">
                                        <button class="nav-link active" id="pro-1-tab" data-bs-toggle="tab" data-bs-target="#pro-1" type="button" role="tab"
                                            ...
                                            <img src="{{('Frontend/assets/images/product/quickview-s1.jpg')}}" alt="product-thumbnail">
                                        </button>
                                        <button class="nav-link" id="pro-2-tab" data-bs-toggle="tab" data-bs-target="#pro-2" type="button" role="tab"
                                            ...
                                            <img src="{{('Frontend/assets/images/product/quickview-s2.jpg')}}" alt="product-thumbnail">
                                        </button>
                                        <button class="nav-link" id="pro-3-tab" data-bs-toggle="tab" data-bs-target="#pro-3" type="button" role="tab"
                                            ...
                                            <img src="{{('Frontend/assets/images/product/quickview-s3.jpg')}}" alt="product-thumbnail">
                                        </button>
                                    </div>
                                </div>
                            </div>
