        ...
        <div class="row">
            ...
            <div class="col-6">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Sửa Danh sách vai trò</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0" style="display:flex; justify-content: space-between;">
                        <h3>Sửa Danh sách vai trò</h3>
                        <span style=" margin-top: 3px;">
                              @include('Backend.admin.alert')
                        </span>
                    </div>
                    <form class="form theme-form" action="{{route('roles.update',$role->id)}}" method="Post" >
                        @method('PUT')
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <label class="col-sm-3 col-form-label">Tên vai trò</label>
                                        <div class="col-sm-9">
                                            <input class="form-control" type="text" value="{{$role->role_name}}" name="role_name">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label">Nội dung</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control tinymce_edit" style="resize: none" rows="6" cols="6" name="display_name" placeholder="Nội dung vai trò">{{$role->display_name}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div style="border: 1px solid #EFF3F9">
                                            <div class="page-builder">
                                                <div id="myGrid">
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-header" style="background-color: #f7a6f7; display:flex;border: 1px solid #EFF3F9; border-radius: 10px" >
                                                                <input
                                ...
                                @foreach ($permissionParent as $perParentItem)
                                    <div class="container-fluid cart_parent" style="margin-top: 24px">
                                        <div class="page-builder">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div style="background-color: #eff3f9; display:flex; padding: 25px ; border: 1px solid #EFF3F9">
                                                        <input
                                                            style="font-size: 20px"
                                                                    ...
                                                                    <div class="row" >
                                                                        @foreach ($perParentItem->permissionChildren as $perChildItem)
                                                                            <div class="col-md-3" >
                                                                                ...
                                                                                {{$permissionCheck->contains('id',$perChildItem->id) ? 'checked' : ""}}
